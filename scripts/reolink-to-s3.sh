...
WATCH_DIRS=("/media/reolink" "/media/reolink_front" "/media/reolink_sideway" "/media/reolink_gardenside" "/media/reolink_roberts_front" "/media/reolink_roberts_garden" "/media/reolink_navi_front")
